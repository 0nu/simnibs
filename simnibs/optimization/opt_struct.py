...
class TMSoptimize():
    ...
    def run(self, cpus=1, allow_multiple_runs=False, save_mat=True):
        ...
        # write coil positions in .hdf5 file (from Ole and Konstantin)
        try:
            from pyfempp import write_coil_pos_hdf5
            write_coil_pos_hdf5(fn_hdf=os.path.join(dir_name, "search_positions.hdf5"),
